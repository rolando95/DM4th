...
inline number newtonRaphson(Function f, number x1, number maxIter, number tolerance){
...
inline number newtonRaphson(Function f, Function fd, number x1, number maxIter, number tolerance){
    if(abs(f(x1))<tolerance)
    {
        return x1;
    }
...
inline number secantMethod(Function f, number x0, number x1, number maxIter, number tolerance){
