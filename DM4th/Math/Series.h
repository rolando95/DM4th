...
inline number sumatory(const std::function<number(number)> &f, NDArray<number>, const number increment=1); 
// sumatory(f, begin, end, interval)
inline number sumatory(const std::function<number(number)> &f, number begin, number end, const number increment=1); 
...
inline number product(const std::function<number(number)> &f, NDArray<number>, const number increment=1); 
// product(f, begin, end, interval)
inline number product(const std::function<number(number)> &f, number, number, const number increment=1); 
